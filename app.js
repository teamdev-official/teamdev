...
app.get('/docs/downloader', isAuthenticated, async (req, res) => { 
...
app.get('/docs/searching', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
...
app.get('/docs/ceritapendek', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('cerpen', {
    username: username,
    apikey: apikey,
...
app.get('/docs/nsfwsfw', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('nsfwsfw', {
    username: username,
    apikey: apikey,
...
app.get('/docs/randomanime', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('randomanime', {
    username: username,
    apikey: apikey,
    email,
    layout: 'randomanime'
...
app.get('/docs/entertainment', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
...
app.get('/docs/asupan', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('asupan', {
    username: username,
    apikey: apikey,
...
app.get('/docs/stalking', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('stalking', {
    username: username,
    apikey: apikey,
...
app.get('/docs/primbon', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('primbon', {
    username: username,
    apikey: apikey,
...
app.get('/docs/vokalgenerator', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('vokal', {
    username: username,
    apikey: apikey,
...
app.get('/docs/other', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('other', {
    username: username,
    apikey: apikey,
...
app.get('/docs/islami', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('islami', {
    username: username,
    apikey: apikey,
...
app.get('/docs/randomtext', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('randomtext', {
    username: username,
    apikey: apikey,
    email,
    layout: 'randomtext'
...
app.get('/docs/randomimage', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
...
app.get('/admin/listuser', isAuthenticated, async (req, res) => {
  ...
  if (username !=='Xsec7') return res.redirect('/docs');
